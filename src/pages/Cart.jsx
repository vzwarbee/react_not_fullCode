        ...
        <Helmet title="Shopping Cart">
            ...
            <Container>
                <Row>
                    ...
                    <Col lg='3'>
                        <div>
                            <h6 className="d-flex align-items-center justify-content-between mt-4">
                                Subtotal
                                <span className="fs-4 fw-bold">${totalAmount}</span>

                            </h6>
                        </div>
                        <p className="fsz-6 mt-2">taxes and shipping will calculate in checkout.</p>
                        <div className=" ">
                            <button className="buy__btn w-100"><Link to='/checkout'>Checkout</Link></button>

                            <button className="buy__btn w-100 mt-3"><Link to='/shop'>Continue</Link></button>
